...
export class Typegoose {
  getModelForClass<T>(t: T, { existingMongoose, schemaOptions, existingConnection, indexes }: GetModelForClassOptions = {}) {
  ...
  setModelForClass<T>(t: T, { existingMongoose, schemaOptions, existingConnection, indexes }: GetModelForClassOptions = {}) {
    const name = this.constructor.name;
